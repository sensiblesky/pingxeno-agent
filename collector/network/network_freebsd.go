...
func (c *FreeBSDCollector) GetInterfaces() ([]protocol.NetworkInterface, error) {
...
func (c *FreeBSDCollector) GetIO() (bytesSent, bytesRecv, packetsSent, packetsRecv int64, err error) {
