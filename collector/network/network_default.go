...
func (c *DefaultCollector) GetInterfaces() ([]protocol.NetworkInterface, error) {
...
func (c *DefaultCollector) GetIO() (bytesSent, bytesRecv, packetsSent, packetsRecv int64, err error) {
