...
func (c *LinuxCollector) GetInterfaces() ([]protocol.NetworkInterface, error) {
...
func (c *LinuxCollector) GetIO() (bytesSent, bytesRecv, packetsSent, packetsRecv int64, err error) {
